...
const CONFIG = {
  ...
  seo: {
    title: 'Portfolio of Krishna Garcha',
    description: '',
    imageURL: '',
  },
  social: {
    linkedin: 'krishna-garcha',
    twitter: '',
    mastodon: '',
    facebook: '',
    instagram: '',
  ...
  resume: {
    fileUrl:
      'https://drive.google.com/file/d/1PDawDi2f1Q_dvH15xfR5RvRmALNinWdJ/view?usp=sharing', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'Racket - ISL',
    'Java',
